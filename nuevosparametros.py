...
##
#aqui añadimos nuevos posibles valores para los miembros del ejercito para ver si existe otra mejor soulcion posible con mayor poder 
#para los nuevos valores
##
UNITS = ['Swordsmen', 'Bowmen', "Horsemen"]
